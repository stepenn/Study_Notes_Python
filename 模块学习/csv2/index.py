import csv
#调用csv模块
with open('d:/360MoveData/Users/Administrator/Desktop/python_learn/csv2/assets.csv', 'a', newline='') as csvfile:
...
while unit_loop:
    ...
    with open('d:/360MoveData/Users/Administrator/Desktop/python_learn/csv2/assets.csv', 'a', newline='',encoding = 'GBK')as csvfile:
    #Mac用户要加多一个参数 encoding = 'GBK'
        writer = csv.writer(csvfile, dialect='excel')
        for sub_dict in unit_rooms.values():
            for room,info in sub_dict.items():
                dire = ['', '南北', '东西']
                infos = [title,address,year,block,unit,room,dire[info[0]],info[1]]
                print(infos)
